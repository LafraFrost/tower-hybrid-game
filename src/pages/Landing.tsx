...
import { Shield, Sword, Sparkles, Heart, Wrench } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center relative overflow-hidden p-4">
      ...
      <motion.div 
        ...
        className="z-10 w-full max-w-lg space-y-6"
      >
        {/* Title */}
        <div className="text-center space-y-2">
          ...
          <p className="text-cyan-500/80 font-mono tracking-[0.2em] text-xs uppercase">Select Your Operative</p>
        </div>
        ...
        <div className="text-center space-y-2">
          ...
          >
            {selectedHeroName ? `DEPLOY ${selectedHeroName.toUpperCase()}` : "SELECT OPERATIVE"}
          </NeonButton>
